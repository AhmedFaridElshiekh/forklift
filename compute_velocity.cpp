...
#include "pid.h"
/*
* * Computes the desired linear and angular velocities for the robot based on its current state.
 * If the robot is in the MOVE_FORWARD state, it calculates both linear and angular velocities.
 * If it is in the ROTATE_TO_TARGET state, it only calculates the angular velocity and set linear to zero.
 * The computed velocities are then converted from unicycle to differential drive format.
 *
