...
// PID parameters
#define KP_LINEAR_VELOCITY  1.0f /* PID gains for linear velocity control */
#define KI_LINEAR_VELOCITY  0.0f
#define KD_LINEAR_VELOCITY  0.0f
#define KP_HEADING 1.0f /* PID gains for heading control */
#define KI_HEADING 1.0f
#define KD_HEADING 1.0f
#define TAU .5f
